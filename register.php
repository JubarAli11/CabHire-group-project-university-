...
<!--
	...
	Functonality : This page is provided to customers to register for private car hires application.
...
--> 
  ...
  <H1>Private Car Hires</H1>
	<H2>Register to Private Car Hires</H2>
...
<?php 
	...
	function ValidateEmail($emailid,$name)
	{
		...
		if(strpos($emailid, '@') > 0 && strpos($emailid, '.') > strpos($emailid, '@')+1 && strpos(strrev($emailid), '.') > 0)
		{
			...
			$header = "From: chico_lex@yahoo.com";
